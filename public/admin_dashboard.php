...
<head>
    ...
    <link rel="icon" type="image/png" href="../assets/images/terraingo-
logo.png">
        ...
        <main class="main-content">
            ...
            <section class="dashboard-card">
                ...
                <p class="dashboard-intro">
                    Bienvenue dans l’espace admin de TerrainGo.
                    Depuis cet espace, vous pourrez bientôt gérer les terrains et
                    les réservations.
                </p>
